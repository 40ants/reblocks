...
in a declarative manner, with error checking and reporting included. 
...
how to render an HTML table.

View fields usually mapped to the slots of your data class but they were
flexible enough to be used in any other way. Associated with each view field
regardless of the view type were things like a human-readable label and
