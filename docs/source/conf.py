# -*- coding: utf-8 -*-
#
# weblocks documentation build configuration file, created by
...
latex_documents = [
  ('index', 'weblocks.tex', u'weblocks Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'weblocks', u'weblocks Documentation',
     [u''], 1)
]
...
texinfo_documents = [
  ('index', 'weblocks', u'weblocks Documentation',
   u'', 'weblocks', 'Weblocks is an advanced web framework written in Common Lisp.',
   'Miscellaneous'),
]
