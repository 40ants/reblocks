...
<div class=demo>
 <iframe
         ...
         id=example-126
         src="http://localhost:40000/examples/weblocks/doc/quickstart/example1?iframe-id=example-126"
...
<div class=demo>
 <iframe
         sandbox="allow-forms allow-same-origin allow-scripts"
         id=example-127
         src="http://localhost:40000/examples/weblocks/doc/quickstart/example2?iframe-id=example-127"
...
<div class=demo>
 <iframe
         sandbox="allow-forms allow-same-origin allow-scripts"
         id=example-128
         src="http://localhost:40000/examples/weblocks/doc/quickstart/example3?iframe-id=example-128"
         style="width: 100%; height: 15em; border: 0"></iframe>
</div>
<script>
window.addEventListener('message', function(e) {
