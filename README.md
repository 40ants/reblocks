...
application. [`weblocks/widget:defwidget`][650b] is similar to Common Lisp's `DEFCLASS`,
...
[`weblocks/widget:render`][b3ad] generic-function for our newly defined classes:
        ...
        (with-html
              ...
              (:ul
                (loop for task in (tasks widget) do
                      (:li (render task))))))
```
The [`weblocks/html:with-html`][9796] macro uses
...
[`weblocks/widget:render`][b3ad] generic-function in the `REPL`:
...
in the browser. Here it rerenders the task-list widget, but we can as well [`weblocks/widget:update`][fade]
...
[9796]: api.html#x-28WEBLOCKS-2FHTML-3AWITH-HTML-20-2840ANTS-DOC-2FLOCATIVES-3AMACRO-29-29
[650b]: api.html#x-28WEBLOCKS-2FWIDGETS-2FBASE-3ADEFWIDGET-20-2840ANTS-DOC-2FLOCATIVES-3AMACRO-29-29
[b3ad]: api.html#x-28WEBLOCKS-2FWIDGETS-2FBASE-3ARENDER-20GENERIC-FUNCTION-29
[fade]: api.html#x-28WEBLOCKS-2FWIDGETS-2FBASE-3AUPDATE-20GENERIC-FUNCTION-29
