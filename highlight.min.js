...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `bash` grammar compiled for Highlight.js 11.12.0 */
...
;hljs.registerLanguage("bash",e)})();/*! `css` grammar compiled for Highlight.js 11.12.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("css",e)})();/*! `json` grammar compiled for Highlight.js 11.12.0 */
...
illegal:"\\S"}}})();hljs.registerLanguage("json",e)})();/*! `lisp` grammar compiled for Highlight.js 11.12.0 */
...
illegal:null}),g=e.COMMENT(";","$",{relevance:0}),r={scope:"variable",
match:/\*[^\s()*]+\*/},t={className:"symbol",begin:"[:&]"+n},c={begin:n,
relevance:0},d={begin:a},o={contains:[l,b,r,t,{begin:"\\(",end:"\\)",
contains:["self",s,b,l,c]},c],variants:[{begin:"['`]\\(",end:"\\)"},{
begin:"\\(quote ",end:"\\)",keywords:{name:"quote"}},{begin:"'"+a}]},v={
variants:[{begin:"'"+n},{begin:"#'"+n+"(::"+n+")*"}]},m={begin:"\\(\\s*",
end:"\\)"},u={endsWithParent:!0,relevance:0};return m.contains=[{
className:"name",variants:[{begin:n,relevance:0},{begin:a}]
},u],u.contains=[o,v,m,s,l,b,g,r,t,d,c],{name:"Lisp",illegal:/\S/,
...
;hljs.registerLanguage("markdown",e)})();/*! `plaintext` grammar compiled for Highlight.js 11.12.0 */
(()=>{var t=(()=>{"use strict";return t=>({name:"Plain text",
aliases:["text","txt"],disableAutodetect:!0})})()
;hljs.registerLanguage("plaintext",t)})();/*! `xml` grammar compiled for Highlight.js 11.12.0 */
(()=>{var e=(()=>{"use strict";return e=>{
