...
* Generic-function [`reblocks/widget:create-widget-from`][62cc] now returns a more user-friendly error
  message, explaining that the widget is not of a good type, instead
  of "no applicable generic method".

* A new function [`reblocks/preview:preview`][aed2] was added. Give it a widget and it will setup
...
* Function [`reblocks/server:stop`][d67c] now accepts optional `interface` and `port` arguments.

* Function `reblocks/action::function-or-action->action` was renamed to [`reblocks/actions:make-action`][b74e] and made public.
...
* Function [`reblocks/actions:make-action-url`][3493] is exported now and it keeps query params by default.

<a id="new-functions"></a>

### New Functions

* [`reblocks/server:servers`][48a0]

* [`reblocks/server:running-p`][bf49]
...
* A variable `*current-page-headers*`, define an `:AFTER` method for [`reblocks/page:render-headers`][8f26] instead.
...
* A new macro [`reblocks/routes:defroute`][1376] was added.
...
[b74e]: actions/#x-28REBLOCKS-2FACTIONS-3AMAKE-ACTION-20FUNCTION-29
[3493]: actions/#x-28REBLOCKS-2FACTIONS-3AMAKE-ACTION-URL-20FUNCTION-29
[8f26]: apps/#x-28REBLOCKS-2FPAGE-3ARENDER-HEADERS-20GENERIC-FUNCTION-29
...
[1376]: routing/#x-28REBLOCKS-2FROUTES-3ADEFROUTE-20-2840ANTS-DOC-2FLOCATIVES-3AMACRO-29-29
[62cc]: widgets/#x-28REBLOCKS-2FWIDGET-3ACREATE-WIDGET-FROM-20GENERIC-FUNCTION-29
