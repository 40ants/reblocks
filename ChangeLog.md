...
* Generic-function [`reblocks/widget:create-widget-from`][e030] now returns a more user-friendly error
  message, explaining that the widget is not of a good type, instead
  of "no applicable generic method".

* A new function [`reblocks/preview:preview`][1a4d] was added. Give it a widget and it will setup
...
* Function [`reblocks/server:stop`][29dc] now accepts optional `interface` and `port` arguments.

* Function `reblocks/action::function-or-action->action` was renamed to [`reblocks/actions:make-action`][354b] and made public.
...
* Function [`reblocks/actions:make-action-url`][f705] is exported now and it keeps query params by default.

<a id="new-functions"></a>

### New Functions

* [`reblocks/server:servers`][70fe]

* [`reblocks/server:running-p`][511f]
...
* A variable `*current-page-headers*`, define an `:AFTER` method for [`reblocks/page:render-headers`][cf86] instead.
...
Hooks `API` was refactored in a backward incompatible manner. [`reblocks/hooks:defhook`][4499] macro now requires
to specify hook's arguments and all macros generated by the [`reblocks/hooks:defhook`][4499] also require arguments
specification.
...
* A new macro [`reblocks/routes:defroute`][df5c] was added.
...
[354b]: actions.html#x-28REBLOCKS-2FACTIONS-3AMAKE-ACTION-20FUNCTION-29
[f705]: actions.html#x-28REBLOCKS-2FACTIONS-3AMAKE-ACTION-URL-20FUNCTION-29
[cf86]: apps.html#x-28REBLOCKS-2FPAGE-3ARENDER-HEADERS-20GENERIC-FUNCTION-29
[1a4d]: components.html#x-28REBLOCKS-2FPREVIEW-3APREVIEW-20FUNCTION-29
[511f]: components.html#x-28REBLOCKS-2FSERVER-3ARUNNING-P-20FUNCTION-29
[70fe]: components.html#x-28REBLOCKS-2FSERVER-3ASERVERS-20FUNCTION-29
[29dc]: components.html#x-28REBLOCKS-2FSERVER-3ASTOP-20FUNCTION-29
[4499]: hooks.html#x-28REBLOCKS-2FHOOKS-3ADEFHOOK-20-2840ANTS-DOC-2FLOCATIVES-3AMACRO-29-29
...
[df5c]: routing.html#x-28REBLOCKS-2FROUTES-3ADEFROUTE-20-2840ANTS-DOC-2FLOCATIVES-3AMACRO-29-29
[e030]: widgets.html#x-28REBLOCKS-2FWIDGET-3ACREATE-WIDGET-FROM-20GENERIC-FUNCTION-29
